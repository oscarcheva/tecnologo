...
// Pre-Cond: La cadena no es vacia y tiene al menos un elemento
// Pos-Cond: Agrega un caracter al final de la cadena
void agregarCaracterFinalCadena(Cadena &cadena, char caracter);

// Pre-Cond: La cadena no es vacia y tiene al menos un elemento
// Pos-Cond: Elimina el ultimo caracter al final de la cadena
