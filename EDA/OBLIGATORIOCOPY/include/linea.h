...
// Pos-Cond: Imprime en pantalla los cambios que hubo en linea2 respecto a linea1
...
// Pos-Cond: Elimina toda la memoria de la estructura Linea "linea" y sus nodos siguientes
